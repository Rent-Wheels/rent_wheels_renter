...
class ChangeCarAvailability extends UseCase<CarInfo, String> {
  final CarsRepository repository;

  ChangeCarAvailability({required this.repository});

  @override
  Future<Either<String, CarInfo>> call(String params) async {
    return await repository.changeCarAvailability(carId: params);
  }
}
